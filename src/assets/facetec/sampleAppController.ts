...
import {
  ...
  GetLatestEnrollmentIdentifier, OnComplete
...
export const SampleApp = (function() {
  let latestEnrollmentIdentifier = "";
  let latestProcessor: LivenessCheckProcessor | EnrollmentProcessor | AuthenticateProcessor | PhotoIDMatchProcessor;
